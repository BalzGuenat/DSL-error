	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getPackageDeclarationAccess().getAlternatives_3(), "rule__PackageDeclaration__Alternatives_3");
					put(grammarAccess.getCheckerAccess().getAlternatives_3(), "rule__Checker__Alternatives_3");
					...
					put(grammarAccess.getUseTableAccess().getGroup(), "rule__UseTable__Group__0");
					put(grammarAccess.getPackageDeclarationAccess().getGroup(), "rule__PackageDeclaration__Group__0");
					put(grammarAccess.getCheckerAccess().getGroup(), "rule__Checker__Group__0");
					...
					put(grammarAccess.getDomainModelAccess().getPackageDeclarationAssignment(), "rule__DomainModel__PackageDeclarationAssignment");
					put(grammarAccess.getModuleAccess().getNameAssignment_1(), "rule__Module__NameAssignment_1");
					put(grammarAccess.getModuleAccess().getTablesAssignment_3(), "rule__Module__TablesAssignment_3");
					put(grammarAccess.getTableAccess().getNameAssignment_1(), "rule__Table__NameAssignment_1");
					put(grammarAccess.getUseTableAccess().getTableAssignment_2(), "rule__UseTable__TableAssignment_2");
					put(grammarAccess.getPackageDeclarationAccess().getNameAssignment_1(), "rule__PackageDeclaration__NameAssignment_1");
					put(grammarAccess.getPackageDeclarationAccess().getImportSectionAssignment_2(), "rule__PackageDeclaration__ImportSectionAssignment_2");
					put(grammarAccess.getPackageDeclarationAccess().getModuleAssignment_3_0(), "rule__PackageDeclaration__ModuleAssignment_3_0");
					put(grammarAccess.getPackageDeclarationAccess().getCheckerAssignment_3_1(), "rule__PackageDeclaration__CheckerAssignment_3_1");
					put(grammarAccess.getCheckerAccess().getNameAssignment_1(), "rule__Checker__NameAssignment_1");
					put(grammarAccess.getCheckerAccess().getUseTablesAssignment_3_0(), "rule__Checker__UseTablesAssignment_3_0");
					put(grammarAccess.getCheckerAccess().getTablesAssignment_3_1(), "rule__Checker__TablesAssignment_3_1");
					put(grammarAccess.getCheckerAccess().getChecksAssignment_4(), "rule__Checker__ChecksAssignment_4");
					put(grammarAccess.getCheckAccess().getNameAssignment_1(), "rule__Check__NameAssignment_1");
					put(grammarAccess.getCheckAccess().getBodyAssignment_2(), "rule__Check__BodyAssignment_2");
