...
entryRuleUseTable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getUseTableRule()); }
	iv_ruleUseTable=ruleUseTable
	{ $current=$iv_ruleUseTable.current; }
	EOF;

// Rule UseTable
ruleUseTable returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleChecker returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCheckerRule()); }
	iv_ruleChecker=ruleChecker
	{ $current=$iv_ruleChecker.current; }
	EOF;

// Rule Checker
ruleChecker returns [EObject current=null]
@init {
	enterRule();
}
@after {
